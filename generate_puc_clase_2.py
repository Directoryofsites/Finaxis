...
# CONFIGURACIÓN
# =============================================================================
INPUT_FILE = r"c:\ContaPY2\Manual\maestros\PASIVOS.txt"
OUTPUT_FILE = r"c:\ContaPY2\Manual\maestros\PUC_Clase_2_Pasivos.json"
...
def parse_pasivos_txt():
    ...
    for i in range(len(matches)):
        ...
        # FILTRO ESTRICTO: Solo cuentas que empiezan por '2' (Pasivos)
    ...
    print(f"Se encontraron {len(cuentas_raw)} cuentas potenciales (Filtradas solo Clase 2).")
    return cuentas_raw

def generate_puc_clase_2():
    print("Construyendo PUC Maestro - CLASE 2 (PASIVOS)...")
    
    cuentas_raw = parse_pasivos_txt()
    if not cuentas_raw:
    ...
    backup_data = {
        "metadata": {
            ...
            "version_sistema": "7.0",
            "empresa_id_origen": 0,
            "descripcion": "PLANTILLA MAESTRA PUC - CLASE 2 PASIVOS"
        },
        "empresa": {}, 
        "configuracion": {}, 
        "maestros": {
