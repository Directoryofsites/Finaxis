        ...
        <div className="flex flex-col h-full justify-center pb-12 animate-in fade-in zoom-in-95 duration-300">
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
                ...
                <div className="mt-6 pt-6 border-t border-gray-100 text-xs text-gray-400 text-center">
                    <p>Credenciales de Sandbox:</p>
                    <code className="bg-gray-100 px-2 py-1 rounded text-gray-600 mt-1 inline-block">comercial@test.com</code> / <code className="bg-gray-100 px-2 py-1 rounded text-gray-600 mt-1 inline-block">apto500@test.com</code>
                </div>
            </div>
        </div>
    );
                            ...
                            <div key={factura.id} className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-shadow group">
                                ...
                                <div className="flex justify-between items-end mt-3">
                                    <div className="text-xs text-gray-500 flex items-center gap-1">
                                        <Clock size={12} />
                                        Vence: font-medium {factura.fecha_vencimiento}
                                    </div>
...
const PQRView = ({ setCurrentView, setErrorMsg }) => {
    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            // Volver al dash depues de 3 sec
