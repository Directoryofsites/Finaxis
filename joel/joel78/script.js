...
// reemplazar esta URL con la ruta genérica de su servidor B2B2C Público.
const API_BASE_URL = "http://127.0.0.1:8000";

export async function handleLogin(email, documento) {
    try {
...
// =========================================================================
// CAPA VISUAL PÚBLICA (INTERFAZ DE USUARIO Y LÓGICA DEL PORTAL TERCEROS)
// =========================================================================
        ...
        <div className="flex flex-col h-full items-center justify-center animate-in fade-in zoom-in-95 duration-500">
            <div className="w-full max-w-md">
                ...
                <div className="mt-10 pt-8 border-t border-gray-100 text-xs text-center">
                    <p className="text-gray-400 mb-2">Usuarios de Prueba (Sandbox):</p>
    ...
    return (
        <div className="max-w-2xl mx-auto animate-in fade-in zoom-in-95 duration-500 h-full flex flex-col justify-center">
            <div className="mb-8 text-center">
                ...
                <p className="text-base text-gray-500">Radica tus Peticiones, Quejas o Reclamos asociadas a tu cuenta.</p>
            </div>
