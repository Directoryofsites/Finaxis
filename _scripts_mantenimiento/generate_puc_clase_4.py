...
# CONFIGURACIÓN
# =============================================================================
INPUT_FILE = r"c:\ContaPY2\Manual\maestros\ingresos.txt"
OUTPUT_FILE = r"c:\ContaPY2\Manual\maestros\PUC_Clase_4_Ingresos.json"
...
def parse_ingresos_txt():
    ...
    for i in range(len(matches)):
        ...
        # FILTRO ESTRICTO: Solo cuentas que empiezan por '4' (Ingresos)
    ...
    print(f"Se encontraron {len(cuentas_raw)} cuentas potenciales (Filtradas solo Clase 4).")
    return cuentas_raw

def generate_puc_clase_4():
    print("Construyendo PUC Maestro - CLASE 4 (INGRESOS)...")
    
    cuentas_raw = parse_ingresos_txt()
    if not cuentas_raw:
    ...
    backup_data = {
        "metadata": {
            ...
            "version_sistema": "7.0",
            "empresa_id_origen": 0,
            "descripcion": "PLANTILLA MAESTRA PUC - CLASE 4 INGRESOS"
        },
        "empresa": {}, 
        "configuracion": {}, 
        "maestros": {
