...
# CONFIGURACIÓN
# =============================================================================
INPUT_FILE = r"c:\ContaPY2\Manual\maestros\patrimonio.txt"
OUTPUT_FILE = r"c:\ContaPY2\Manual\maestros\PUC_Clase_3_Patrimonio.json"
...
def parse_patrimonio_txt():
    ...
    for i in range(len(matches)):
        ...
        # FILTRO ESTRICTO: Solo cuentas que empiezan por '3' (Patrimonio)
        if not codigo.startswith('3'):
            continue
    ...
    print(f"Se encontraron {len(cuentas_raw)} cuentas potenciales (Filtradas solo Clase 3).")
    return cuentas_raw

def generate_puc_clase_3():
    print("Construyendo PUC Maestro - CLASE 3 (PATRIMONIO)...")
    
    cuentas_raw = parse_patrimonio_txt()
    if not cuentas_raw:
    ...
    backup_data = {
        "metadata": {
            ...
            "version_sistema": "7.0",
            "empresa_id_origen": 0,
            "descripcion": "PLANTILLA MAESTRA PUC - CLASE 3 PATRIMONIO"
        },
        "empresa": {}, 
        "configuracion": {}, 
        "maestros": {
