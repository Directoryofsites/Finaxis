...
// import { useSearchParams } from 'next/navigation'; // REMOVIDO DEFINITIVAMENTE
import dynamic from 'next/dynamic';
import { useAuth } from '../../../context/AuthContext';
import { apiService } from '../../../../lib/apiService';

// --- COMPONENTE INTERNO SEGURO ---
// --- COMPONENTE INTERNO SEGURO - VANILLA JS IMPLEMENTATION ---
const DeepLinkListener = ({ onTrigger }) => {
    useEffect(() => {
        // Ejecución estrictamente Client-Side
    ...
    }, [onTrigger]); // Sin dependencias de Next.js
    return null;
};
...
import Select, { components } from 'react-select'; // REINTRODUCIDO: Faltaba esta librería crítica
...
function ParametrosInventarioContent() {
    const { user } = useAuth();
    ...
    return (
        <div className="container mx-auto p-4 md:p-8 bg-gray-50 min-h-screen font-sans">
            ...
            <React.Suspense fallback={null}>
                <DeepLinkListener onTrigger={(t) => {
                    if (t === 'tab_groups') setActiveTab('grupos');
                    else if (t === 'tab_warehouses') setActiveTab('bodegas');
                }} />
            </React.Suspense>
...
export default ParametrosInventarioContent;
