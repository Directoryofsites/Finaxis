    ...
    return (
        <div className={`fixed right-0 top-0 bottom-0 z-[60] transition-all duration-300 ease-spring ${widthClass} ${glassClass} flex`}>
            ...
            <div className="w-12 flex flex-col items-center py-4 bg-gray-50/50 border-r border-gray-200 h-full flex-shrink-0">
                ...
                <button onClick={() => router.push('/contabilidad/captura-rapida/monitor')} className={`nav-item mb-6 p-2 rounded-xl transition-all ${pathname === '/contabilidad/captura-rapida/monitor' ? 'bg-emerald-100 text-emerald-700 shadow-sm' : 'text-gray-400 hover:text-emerald-600 hover:bg-emerald-50'}`} title="Monitor de Asientos"><FaBolt className="text-xl" /></button>
