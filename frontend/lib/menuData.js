...
export const menuStructure = [
    // 1. Contabilidad General -> Contabilidad (C)
    {
        ...
        links: [
            ...
            { name: 'Escanear Buzón', href: '/contabilidad/buzon-tributario', mnemonic: 'z', icon: FaEnvelope, description: 'Contabilización automática desde el correo.', permission: 'contabilidad:captura_rapida' },
            ...
            { name: 'Comparación Mensual de Saldos', href: '/contabilidad/reportes/comparacion-saldos', mnemonic: 'm', icon: FaCheckCircle, description: 'Análisis comparativo de saldos de fin de mes.', permission: 'contabilidad:balance_prueba' },
