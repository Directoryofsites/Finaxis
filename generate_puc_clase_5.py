...
# CONFIGURACIÓN
# =============================================================================
INPUT_FILE = r"c:\ContaPY2\Manual\maestros\gastos.txt"
OUTPUT_FILE = r"c:\ContaPY2\Manual\maestros\PUC_Clase_5_Gastos.json"
...
def parse_gastos_txt():
    ...
    for i in range(len(matches)):
        ...
        # FILTRO ESTRICTO: Solo cuentas que empiezan por '5' (Gastos)
    ...
    print(f"Se encontraron {len(cuentas_raw)} cuentas potenciales (Filtradas solo Clase 5).")
    return cuentas_raw

def generate_puc_clase_5():
    print("Construyendo PUC Maestro - CLASE 5 (GASTOS)...")
    
    cuentas_raw = parse_gastos_txt()
    if not cuentas_raw:
    ...
    backup_data = {
        "metadata": {
            ...
            "version_sistema": "7.0",
            "empresa_id_origen": 0,
            "descripcion": "PLANTILLA MAESTRA PUC - CLASE 5 GASTOS"
        },
        "empresa": {}, 
        "configuracion": {}, 
        "maestros": {
