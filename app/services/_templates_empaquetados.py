    ...
    <div style="margin-top: 20px; page-break-inside: avoid;">
        ...
        <table style="margin-top: 0; border: 1px solid #ccc; width: 100%;">
            ...
            <tbody>
                ...
                <tr>
                    <td style="padding: 4px;"><strong>Nivel 1:</strong> Intereses de Mora</td>
                    <td class="text-right font-mono" style="padding: 4px;">$ {{ ph_distribucion.intereses|format_decimal(0) }}</td>
                </tr>
                {% endif %}
                {% if ph_distribucion.multas > 0 %}
                <tr>
                    <td style="padding: 4px;"><strong>Nivel 2:</strong> Multas y Sanciones</td>
                    <td class="text-right font-mono" style="padding: 4px;">$ {{ ph_distribucion.multas|format_decimal(0) }}</td>
                </tr>
                {% endif %}
                {% if ph_distribucion.capital > 0 %}
                <tr>
                    <td style="padding: 4px;"><strong>Nivel 3:</strong> Capital (Cuotas de Admin. y otros)</td>
                    <td class="text-right font-mono" style="padding: 4px;">$ {{ ph_distribucion.capital|format_decimal(0) }}</td>
                </tr>
                {% endif %}
