...
from app.models import bodega as models_bodega # AGREGADO: Para deducir empresa desde bodega
...
@router.post("/bodegas", response_model=schemas.Bodega, status_code=status.HTTP_201_CREATED, dependencies=[Depends(has_permission("inventario:gestionar_parametros"))])
...
@router.put("/bodegas/{bodega_id}", response_model=schemas.Bodega, dependencies=[Depends(has_permission("inventario:gestionar_parametros"))])
...
@router.delete("/bodegas/{bodega_id}", dependencies=[Depends(has_permission("inventario:gestionar_parametros"))])
...
@router.get("/grupos/search", response_model=List[schemas.GrupoInventarioSimple], dependencies=[Depends(has_permission("inventario:gestionar_parametros"))])
...
@router.get("/grupos/{grupo_id}", response_model=schemas.GrupoInventario, dependencies=[Depends(has_permission("inventario:gestionar_parametros"))])
...
@router.post("/grupos/{grupo_id}/caracteristicas", response_model=schemas.CaracteristicaDefinicion, status_code=status.HTTP_201_CREATED, dependencies=[Depends(has_permission("inventario:gestionar_parametros"))])
...
@router.put("/caracteristicas/{definicion_id}", response_model=schemas.CaracteristicaDefinicion, dependencies=[Depends(has_permission("inventario:gestionar_parametros"))])
...
@router.delete("/caracteristicas/{definicion_id}", dependencies=[Depends(has_permission("inventario:gestionar_parametros"))])
...
@router.post("/grupos/{grupo_id}/reglas-precio", response_model=schemas.ReglaPrecioGrupo, status_code=status.HTTP_201_CREATED, dependencies=[Depends(has_permission("inventario:gestionar_parametros"))])
...
@router.delete("/reglas-precio/{regla_id}", dependencies=[Depends(has_permission("inventario:gestionar_parametros"))])
...
def get_productos_flat_route(db: Session = Depends(get_db), current_user: models_usuario.Usuario = Depends(get_current_user)):
    ...
    """
    productos = db.query(models_producto.Producto).filter(
...
@router.delete("/productos/{producto_id}", dependencies=[Depends(has_permission("inventario:eliminar_producto"))])
...
@router.get("/productos/search", response_model=List[schemas.ProductoAutocompleteItem], dependencies=[Depends(has_permission("inventario:ver_productos"))])
